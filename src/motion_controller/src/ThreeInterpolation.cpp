...
/**
     ...
     */
ThreeInterpolation::ThreeInterpolation(std::shared_ptr<Parameters> param,const std::vector<double> &x_array,
                                       const std::vector<double> &y_array,
                                       const std::vector<double> &s_angle):parameters(param)
{
...
/**
     ...
     * @param y_array
     */
ThreeInterpolation::ThreeInterpolation(std::shared_ptr<Parameters> param,const std::vector<double> &x_array,const std::vector<double> &y_array):parameters(param)
{
    x_array_ = x_array;
    y_array_ = y_array;
    time_interval_ = parameters->three_interpolation_param.DEFAULT_POINT_INTERVAL;
...
void ThreeInterpolation::CalculatePoints()
{
    return CalculatePoints(parameters->three_interpolation_param.DEFAULT_POINT_INTERVAL);
}
